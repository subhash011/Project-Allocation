...
export class SubmitPopUpComponent implements OnInit {
    constructor(@Inject(MAT_DIALOG_DATA) public data: any, private projectService: ProjectsService, private dialogRef: MatDialogRef<SubmitPopUpComponent>, private dialog: MatDialog) {}
        ...
        this.projectService.updateProject(this.data).subscribe((data) => {
            ...
            if (data["status"] == "success") {
                ...
                this.dialogRef.close({
                    message: "studentCap", msg: data["msg"]
                });
            } else if (data["status"] == "fail2") {
                this.dialogRef.close({
                    message: "studentsPerFaculty", msg: data["msg"]
                });
            } else {
