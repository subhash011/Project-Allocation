                ...
                if (data["status"] == "success") {
                    ...
                    this.activatedRoute.queryParams.subscribe(
                        (params) => {
                            ...
                            this.userService.getFacultyPrograms().subscribe(
                                (data) => {
                                    ...
                                    if (data["status"] == "success") {
                                        ...
                                        this.curr_program = this.programs.filter(
                                            (val) => val.short == this.stream
                                        )[0];
                                        ...
                                        this.userService
                                            ...
                                            .subscribe(
                                                (data) => {
                                                    ...
                                                    this.stageHomeDetails =
                                                        data["stageDetails"];
                                                    this.projectHomeDetails =
                                                        data["projects"];
                                                    this.program_details = this.projectHomeDetails.filter(
                                                        (val) =>
                                                            val.stream ==
                                                            this.stream
                                                    );
                            ...
                            this.userService
                                .getPublishMode("faculty")
                                .subscribe(
                                    (responseAPI: HttpResponseAPI) => {
                                        this.publishFaculty =
                                            responseAPI.result.publishFaculty;
                                        this.publishStudents =
                                            responseAPI.result.publishStudents;
                                    },
                                    () => {
                                        dialogRefLoad.close();
                                    }
