...
import {
    CheckLogIn,
    LoginComponent,
} from "src/app/components/shared/login/login.component";
import { BrowserAnimationsModule } from "@angular/platform-browser/animations";
import {
    CheckRegister,
    GetLinksForNavBar,
    NavbarComponent,
} from "src/app/components/shared/navbar/navbar.component";
...
import {
    ProfileComponent,
    UserPhoto,
} from "src/app/components/shared/profile/profile.component";
import { StudentProjectsComponent } from "src/app/components/student-components/student-projects/student-projects.component";
import {
    ContentComponent,
    FacultyPublish,
} from "src/app/components/faculty-componenets/content/content.component";
...
import {
    ...
    GetRegisteredCount,
    SuperAdminComponent,
} from "src/app/components/shared/super-admin/super-admin.component";
import {
    ActiveProjects,
    AdminComponent,
    AllotedStudents,
...
import {
    CountDown,
    TimelineComponent,
} from "src/app/components/shared/timeline/timeline.component";
...
import {
    ...
    StudentCheck,
    SuperAdminCheck,
} from "src/app/components/shared/Pipes/rolePipes";
